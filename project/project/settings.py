...
SECRET_KEY = 'django-insecure-)yrg^m^et)hq@t_qz72&dl+lhm1ug*lk9c$tau*xni=1&k5!sr'
...
USE_SQLITE = os.environ.get('ONLINECOMMERCE_USE_SQLITE', '1') == '1'
...
if USE_SQLITE:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'onlinecommercedb'),
